...
{
    // Used to send levels to firebase only
    ...
    public string spriteWithQuestionName; //sprite used to illustrate the question
    ...
    public string soundName; //the associated sound if the previous property is true
    ...
    public string SpriteWithQuestionName { get => spriteWithQuestionName; set => spriteWithQuestionName = value; }
